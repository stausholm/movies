const {OMDB_API_EMPTY_VAL_RESPONSE, OMDB_POSTER_IMAGE_SIZES, OMDB_VIDEO_TYPES} = require('./config')
...
function formatVideoObj(originalObj, responseData) {
  let formattedObj = {
    ...
    posterUrl: responseData.Poster && responseData.Poster !== OMDB_API_EMPTY_VAL_RESPONSE ? {
